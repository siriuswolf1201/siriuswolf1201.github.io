 ...
 *
 * 【尚未提供音檔的社先隱藏】收到 mp3 後：
 *   1. 把 mp3 丟進 audio/ 資料夾
 *   2. 到下方 HIDDEN_STATIONS 把該社那行搬回 STATIONS
 *   3. 重排 freq 讓各台間距 1.0、主頻道保持在 348.2，並調整 BAND.min/max
 * ========================================================================== */

export const STATIONS = [
  { id: 1,  name: "台北城中社",     freq: 341.2, audio: "audio/台北城中扶青社.mp3", intro: "城懷大志，中流砥柱！創造持恆商務影響力。",           color: "#f4a259" },
  { id: 2,  name: "台北城東社",     freq: 342.2, audio: "audio/台北城東扶青社.mp3", intro: "城東視界，連結國際！展現新世代國際影響力。",         color: "#f4b942" },
  { id: 3,  name: "台北大稻埕社",   freq: 343.2, audio: "audio/台北大稻埕扶青社.mp3", intro: "埕現經典，創藝無限！讓在地文化發揮持恆影響。",       color: "#e8c468" },
  { id: 4,  name: "台北北海社",     freq: 344.2, audio: "audio/台北北海扶青社.mp3", intro: "愛護海洋，北海最行！共創蔚藍新世紀。",               color: "#c7d49a" },
...
export const HIDDEN_STATIONS = [
  { id: 8,  name: "台北西北區社",   freq: 0, audio: "audio/台北西北區扶青社.mp3", intro: "西北領航，職引未來！共創專業發展影響力。",           color: "#79b6d6" },
  { id: 11, name: "台北上城社",     freq: 0, audio: "audio/台北上城扶青社.mp3", intro: "上城風範，追求卓越！成就新世代商業菁英。",           color: "#7e8fcf" },
  { id: 13, name: "台北百合社",     freq: 0, audio: "audio/台北百合扶青社.mp3", intro: "百合綻放，女力領航！綻放新世紀多元包容影響力。",     color: "#b083c2" },
  { id: 14, name: "台北怡東社",     freq: 0, audio: "audio/台北怡東扶青社.mp3", intro: "怡然自得，綠色永續！怡東引領低碳生活新潮流。",       color: "#c987bb" },
  { id: 16, name: "台北旭日社",     freq: 0, audio: "audio/台北旭日扶青社.mp3", intro: "旭日東升，希望無窮！用教育與書香温暖人心。",         color: "#ec90a3" },
  { id: 18, name: "台北景文科大社",  freq: 0, audio: "audio/台北景文科大扶青社.mp3", intro: "景文創藝，青創力行！展現技職青年在地影響力。",       color: "#f6a5a0" },
];
