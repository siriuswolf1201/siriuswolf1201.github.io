...
- **H&S／贊助物品登錄頁（工作人員專用）** — 網址 `#/hs`，頁面上可切換登錄類型：
  「💛 H&S」登金額、「🎁 贊助物品」登物品名稱，其餘欄位（哪個社 / 暱稱 / 祝賀詞）共用。
  H&S 送出後變成金色便利貼、贊助物品變成青綠色便利貼，混在天幕中一起輪播。
  入口頁**不放連結**，只有拿到網址的工作人員進得去。
...
- **大螢幕**：開 `.../#/wall`，按 F11 全螢幕。想放音樂點右上「🔈 音樂」。
  底部會顯示「共 N 則 · 💛 H&S 累計金額 · 🎁 贊助 N 項」。
- **報到桌**：印出 `.../#/qr` 的 QR，或直接投影邀請頁。
- **H&S 收款／收禮人員**：手機開 `.../#/hs`（加到書籤），收到一筆就登錄一筆；
  收到贊助物品就切到「🎁 贊助物品」登錄。這個網址別放進給來賓的 QR / 投影片。
